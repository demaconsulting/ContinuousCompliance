...
REM Run reqstream lint (uncomment if used)
REM dotnet reqstream --lint --requirements requirements.yaml
REM if errorlevel 1 set "LINT_ERROR=1"

REM Run versionmark lint (uncomment if used)
REM dotnet versionmark --lint
REM if errorlevel 1 set "LINT_ERROR=1"

REM Run reviewmark lint (uncomment if used)
REM dotnet reviewmark --lint
REM if errorlevel 1 set "LINT_ERROR=1"
